...
Board::Board()
{
    ...
    m_Board.push_back(new Property("Unicorn Path", Tile::NO_ACTION, 140, tile_pink_low, 2, 100));
    m_Board.push_back(new Property("Nuclear Power", Tile::UTILITY, 150, tile_utility, 9));
    m_Board.push_back(new Property("Dragon Street", Tile::NO_ACTION, 140, tile_pink_low, 2, 100));
    m_Board.push_back(new Property("Troll Lane", Tile::NO_ACTION, 160, tile_pink_high, 2, 100));
    m_Board.push_back(new Property("Great Station", Tile::NO_ACTION, 200, tile_railroad, 8));
    m_Board.push_back(new Property("Nvidia Way", Tile::NO_ACTION, 180, tile_orange_low, 3, 100));
    m_Board.push_back(new Tile("Community Chest", Tile::CHEST));
    m_Board.push_back(new Property("Dragon Street", Tile::NO_ACTION, 180, tile_orange_low, 3, 100));
    m_Board.push_back(new Property("Graphics Boulevard", Tile::NO_ACTION, 200, tile_orange_high, 3, 100));
    m_Board.push_back(new Tile("Free Parking", Tile::NO_ACTION));
    m_Board.push_back(new Property("Katie Lane", Tile::NO_ACTION, 220, tile_red_low, 4, 150));
    m_Board.push_back(new Tile("Chance", Tile::CHANCE));
    m_Board.push_back(new Property("Artist's Corner", Tile::NO_ACTION, 220, tile_red_low, 4, 150));
    m_Board.push_back(new Property("Digital Way", Tile::NO_ACTION, 240, tile_red_high, 4, 150));
    m_Board.push_back(new Property("Manifest Destiny", Tile::NO_ACTION, 200, tile_railroad, 8));
    m_Board.push_back(new Property("Vermillion Avenue", Tile::NO_ACTION, 260, tile_yellow_low, 5, 150));
    m_Board.push_back(new Property("Maroon Way", Tile::NO_ACTION, 260, tile_yellow_low, 5, 150));
    m_Board.push_back(new Property("Solar Energy", Tile::UTILITY, 150, tile_utility, 9));
    m_Board.push_back(new Property("Yellow Street", Tile::NO_ACTION, 280, tile_yellow_high, 5, 150));
    m_Board.push_back(new Tile("Go to Jail", Tile::JAIL));
    m_Board.push_back(new Property("Baby Court", Tile::NO_ACTION, 280, tile_green_low, 6, 200));
    m_Board.push_back(new Property("Tom Street", Tile::NO_ACTION, 280, tile_green_low, 6, 200));
    m_Board.push_back(new Tile("Community Chest", Tile::CHEST));
    m_Board.push_back(new Property("Neil Boulevard", Tile::NO_ACTION, 300, tile_green_high, 6, 200));
    m_Board.push_back(new Property("New World Express", Tile::NO_ACTION, 200, tile_railroad, 8));
    m_Board.push_back(new Tile("Chance", Tile::CHANCE));
    m_Board.push_back(new Property("Harvey Avenue", Tile::NO_ACTION, 350, tile_blue_low, 7, 200));
    m_Board.push_back(new Tile("Luxury Tax", Tile::LUXURY_TAX));
    m_Board.push_back(new Property("Byrnesville", Tile::NO_ACTION, 400, tile_blue_high, 7, 200));
}
